      ...
      <nav className="flex flex-1 flex-col gap-1.5 p-2 pt-20">
        {navItems.map((item) => (
          <Link
            ...
            className="flex h-10 border border-border bg-background hover:bg-muted hover:text-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground w-full items-center rounded-md px-2.5 transition-all duration-200 group/item"
          >
